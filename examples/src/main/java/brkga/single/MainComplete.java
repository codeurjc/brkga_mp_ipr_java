 ...
 *     examples/tsp/src/single_obj/main_complete.cpp
 *
 * Complete example exercising most of the API: parameter printing, greedy
 * warm start, a new-solution observer, an optional generations stopping
 * criteria, the pre-allocating decoder, best-chromosome extraction, and a CSV
 * one-liner.
 *
 * The original uses docopt; here the same named options are parsed manually.
 *
 * Usage:
...
public class MainComplete {
    ...
    public static void main(String[] argv) {
        ...
        try {
            ...
            // Overwrite the maximum time and the stall iterations.
            ...
            try(BrkgaMpIpr algorithm = new BrkgaMpIpr(
                    ...
                    // Track the best solution evolution.
                    ...
                    // Stop by number of generations, if requested.
                    ...
                    ////////////////////////////////////////
                    log("Optimizing...");
                    System.out.println("* Iteration | Cost | CurrentTime");
                    ...
                    System.out.println(
                        "\n\nInstance,Seed,Cost,NumNodes,TotalIterations,"
                    ...
                    System.out.print(String.format(Locale.US,
                        "%s,%d,%.0f,%d,%d,%d,%.2f,%.2f,%d,%d,%.2f,%d,%d,%d,%d,%d,%d,%d",
                        instanceName, seed, finalStatus.bestFitness[0],
                        instance.numNodes, finalStatus.currentIteration,
                        finalStatus.lastUpdateIteration, finalStatus.currentTime,
                        finalStatus.lastUpdateTime, finalStatus.largestIterationOffset,
                        finalStatus.stalledIterations, finalStatus.pathRelinkTime,
                        finalStatus.numPathRelinkCalls, finalStatus.numHomogenities,
                        finalStatus.numBestImprovements, finalStatus.numEliteImprovements,
                        finalStatus.numExchanges, finalStatus.numShakes,
                        finalStatus.numResets));
                    System.out.flush();
                }
        }
        catch(Exception e) {
    ...
    /// Minimal parser for the "--key value" / "--flag" options used by docopt.
